...
// 拆分出来的一些常数
pub static ENGINE_CONSTANTS_GAME: GameConsts = GameConsts {
    intro_stage: 73,
    intro_event: 90,
    intro_player_pos: (3, 3),
    new_game_stage: 13,
    new_game_event: 94,
    new_game_player_pos: (9, 8),
    tile_offset_x: 0,
};

pub static ENGINE_CONSTANTS_PLAYER:PlayerConsts=PlayerConsts{
    life_locate:233,
    life: 3,
    max_life: 3,
...
pub static ENGINE_CONSTANTS_BOOSTER:BoosterConsts=BoosterConsts{
    fuel: 50,
    b2_0_up: -0x5ff,
    b2_0_up_nokey: -0x5ff,
    b2_0_down: 0x5ff,
...
impl EngineConstants {
    pub fn defaults() -> Self {
        EngineConstants {
            ...
            game: ENGINE_CONSTANTS_GAME,
            player: ENGINE_CONSTANTS_PLAYER,
            booster: ENGINE_CONSTANTS_BOOSTER,
            caret: CaretConsts {
                offsets: [
                    (0, 0),
                    (0x800, 0x800),
